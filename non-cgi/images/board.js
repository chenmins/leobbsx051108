...
clckcnt=0;
if (ie){function ctlent(eventobject){if(event.ctrlKey && window.event.keyCode==13){if(clckcntr()){this.document.FORM.submit();}}if(event.ctrlKey && window.event.keyCode==83){if(clckcntr()){this.document.FORM.submit();}}}}
