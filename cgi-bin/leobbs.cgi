#!/usr/bin/perl
#####################################################
#  LeoBBS X Plus 注册版本 / 雷傲极酷超级论坛注册版  #
#####################################################
...
$rsshtml = qq~<td align=center width=34><a href="rss.cgi?/leo.xml" target="_blank"><img src="$imagesurl/images/xml.gif" border="0" align="absmiddle" alt="RSS 订阅全部论坛"></a></td>~;
if ($regaccess eq "on") {
$rsshtml = "";
}
