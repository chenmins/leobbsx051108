...
&cleanolddata1;
	...
	if ($adminverification eq "yes") {
	    $requirepass = qq~<tr><td bgcolor=$miscbackone colspan=2 align=center><font color=$fontcolormisc><b>ÄúµÄÂÛÌ³ÃÜÂë½«Í¨¹ıÓÊ¼ş¼Ä¸ø¹ÜÀíÔ±£¬ÔÚ¾­¹ı¹ÜÀíÔ±ÈÏÖ¤ºó½«³ĞÈÏÄãµÄ×¢²á£¡</td></tr>~;
    	    ...
    	    $requirepass = qq~<tr><td bgcolor=$miscbackone colspan=2 align=center><font color=$fontcolormisc><b>ÄúµÄÂÛÌ³ÃÜÂë½«Í¨¹ıÓÊ¼ş¼Ä¸øÄú<BR>Èç¹ûÊÇ MSN »ò hotmail µÄĞÅÏä£¬Çë¼ì²é×¢²áĞÅÊÇ·ñ±»·Åµ½ÁËÀ¬»øÏäÄÚ</td></tr>~;
	}
	$qa=qq~~;
    } else {
        $requirepass = qq~<tr>
