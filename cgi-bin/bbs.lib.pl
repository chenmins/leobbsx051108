...
$versionnumber = "<b>L<font color=#F26522>eo</font>B<font color=#00AEEF>BS</font></b> X Build051108";
...
sub uplogintime {
	...
	if (-e $filetoopen) {
	    ...
	    if (($membername ne "")&&($password ne "")) {
	      ...
	      $post1 ||= "0";
	      $post2 ||= "0";
	      $jifen = $post1 * 2 + $post2 - $postdel * 5 if ($jifen eq "");
