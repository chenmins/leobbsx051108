...
$cssinfo =  qq~p				{ text-indent: 2em; }
table			{ font-size: 12px; line-height: 16px}

a				{color: #494949; text-decoration: none;; font-size: 12px; line-height: 15px}
a:active   	{color: #494949; text-decoration: none;; font-size: 12px; line-height: 15px}
a:visited	{color: #494949; text-decoration: none;}
a:hover    	{color: #494949; text-decoration: none;}

a.purple			{color: #494949; text-decoration: none}
a.purple:link		{color: #494949; text-decoration: none;}
a.purple:visited	{color: #494949; text-decoration: none;}
a.purple:active 	{color: #494949;; text-decoration: none;}
.input			{color: #333333; background-color: #FFFFFF; border: 1px #979797 solid; font-size: 12px;}
.tdtitle {  background-color: $titlecolor; color: $titlefont}
.tableborder {  border: #BDBDBD; border-style: solid; border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px}
.tdtext {  background-color: #FFFFFF}
.tt {  background-color: $forumcolorone }
.tt2 {  background-color: $catback }
.tablebox {border: 1px #000000 solid;; background-color:#FFFFFF} 
~;
	...
	$theparam =~ s/\\/\\\\/g;
		...
		${$_} = $theparam;
	if (($_ eq 'titlecolor')||($_ eq 'catback')||($theparam eq "forumcolorone")||($theparam eq "titlefont")) {
	    $cssinfo =~ s/\$$_/$theparam/;
	}
        if ($_ ne 'action') {
        	$_ =~ s/[\n\r]//isg;
        	$theparam =~ s/[\n\r]//isg;
...
if (($membercode eq "ad") && ($inpassword eq $password) && ($password ne "") && ($inmembername ne "") && (lc($inmembername) eq lc($membername))) {
    ...
    open(FILE,">${imagesdir}css/$savename.css");
    print FILE $cssinfo;
    close(FILE);
