...
$rsshtml = qq~  <a href="rss.cgi/leo.xml?forum=$inforum" target="_blank"><img src="$imagesurl/images/xml.gif" border="0" align="absmiddle" alt="RSS 订阅本论坛"></a>~;
...
$output.=qq~ <select name=maiwebvip  onchange="if(this.options[this.selectedIndex].value != '')
...
if (-e "${lbdir}boarddata/forumrule$inforum.cgi") {
   ...
   $forumrule = qq~<span style="height:56;overflow:auto;padding:2px;color:#000000;width:100%;text-align:left">$forumrule</span>~ if ($forumrulelines > 4);
}
