...
@LBCGI::EXPORT = qw (header param cookie redirect uri_escape temppost lbhz cleaninput unclean unHTML HTML cleanarea stripMETA dateformatshort dateformat fulldatetime longdate shortdate longdateandtime shorttime helpfiles helpnewfiles getdir lockfilename winlock winunlock myrand encodeemail);
