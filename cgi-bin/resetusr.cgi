...
<tr bgColor=#ffffff><td><input type=checkbox name=resettype value="mymoney"> 额外金钱</td><td><input type=checkbox name=resettype value="ebankdata"> 银行数据</td><td><input type=checkbox name=resettype value="jifen"> 积分</td><td><input type=checkbox name=resettype value="onlinetime"> 在线时间</td></tr>
