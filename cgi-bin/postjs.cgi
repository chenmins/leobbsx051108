...
&nbsp;$realimg $wmimg <IMG onclick=viewibcode() height=22 alt="点这里查看 LeoBBS 论坛所有的专用标签" src=$imagesurl/btg/help.gif width=23 class="gray" onmouseover="enable(this)" onmouseout="disable(this)">
<br>　
<script>
...
<IMG onclick=center() height=22 alt=居中 src=$imagesurl/btg/center.gif width=23  class="gray" onmouseover="enable(this)" onmouseout="disable(this)">
